...
// 1. Import useNavigate from your router library
  ...
  return (
    ...
    >
      ...
      <div className="bg-white px-4 py-4 flex items-center relative shadow-sm">
        {/* 3. This will now successfully take the user back one step in history */}
        <button
          onClick={() => navigate(-1)} 
        ...
        <h1 className="w-full text-center text-lg font-bold text-gray-900">Transfer History</h1>
      </div>
      ...
      <div className="flex-1 px-4 pt-4 pb-8 flex flex-col gap-4">
        ...
        {/* Back + Title */}
        <div>
          {/* 4. Added the click handler here as well so both buttons work */}
          <button 
            onClick={() => navigate(-1)} 
            className="flex items-center gap-1 text-gray-700 text-sm font-medium mb-2"
          >
            <span className="text-base">&#8249;</span> Back
          </button>
          <h2 className="text-2xl font-extrabold text-gray-900">Transfer History</h2>
        </div>
