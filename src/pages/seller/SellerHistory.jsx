...
export default function SellerHistory() {
  ...
  const fetchSellerHistory = async () => {
    try {
      setLoading(true);
      setError("");
      const result = await api.get("/coinseller/recharge-history");
      console.log("Seller History:", result);
      ...
      console.error("Seller history API error:", err);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f8f9fc] font-sans antialiased">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between
        ...
        <h1 className="text-lg font-bold text-[#1a1a2e]">Seller History</h1>
